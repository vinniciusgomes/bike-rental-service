...
type UserModel struct {
	...
	Image       *string   `json:"image" gorm:"size:500;" validate:"max=500"`
	Verified    bool      `json:"verified" gorm:"not null;default:false" validate:"required"`
	PaymentInfo Payment   `json:"payment_info" gorm:"foreignKey:UserID"`
}
